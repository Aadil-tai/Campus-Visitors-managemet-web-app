...
if(isset($_POST['login']))
  {
    ...
    $query=$con->query("select * from tbluser where  uname='$user' AND upass='$password'");
    
    if(mysqli_num_rows($query)==1){
    $uid = mysqli_fetch_array($query);
      $_SESSION['cvmsaid']="$uid[0]";
      header("location: visitors-form.php");
    }
    else{
                    ...
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#" style="font-size:24px;">
                               PARUL UNIVERSITY Visitor Management System
                            </a>
                        </div>
